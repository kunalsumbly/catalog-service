...
public class HomeController {
    private final PolarProperties appProperties;
    ...
    public HomeController(PolarProperties appProperties,
                          @Qualifier("customStringRedisTemplate") RedisTemplate<String, String> redisTemplate, PolarProperties polarProperties) {
